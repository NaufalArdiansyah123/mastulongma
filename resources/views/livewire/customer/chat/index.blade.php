                ...
                @else
                    <div class="bg-white rounded-xl p-3.5 shadow-sm border border-gray-100 flex flex-col min-h-[60vh]">
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            <div class="w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center font-semibold">{{ strtoupper(substr($selected_help->mitra->name ?? 'M',0,1)) }}</div>
                            <div class="flex-1 min-w-0">
