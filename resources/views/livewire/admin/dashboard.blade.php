<div class="min-h-screen bg-gray-100 flex">
    ...
    <main class="flex-1 ml-64 overflow-y-auto min-h-screen">
        ...
        <div class="p-12">
            <!-- Stats Grid -->
            <div class="grid {{ $isSuperAdmin ? 'grid-cols-4' : 'grid-cols-3' }} gap-8 mb-10">
                <!-- Total Users Card -->
                <div
                    class="bg-white rounded-2xl shadow-md border border-gray-200 p-10 hover:shadow-lg transition-shadow">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-2">Total User</p>
                            <p class="text-5xl font-bold text-gray-900 mt-4">{{ number_format($totalUsers) }}</p>
                        </div>
                ...
                @if($isSuperAdmin)
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-2">Admin Kota</p>
                                <p class="text-5xl font-bold text-gray-900 mt-4">{{ number_format($totalAdmins) }}</p>
                            </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-2">Mitra Aktif</p>
                            <p class="text-5xl font-bold text-gray-900 mt-4">{{ number_format($totalMitras) }}</p>
                        </div>
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-semibold text-gray-600 uppercase tracking-wide mb-2">Kustomer</p>
                            <p class="text-5xl font-bold text-gray-900 mt-4">{{ number_format($totalKustomers) }}</p>
                        </div>
            ...
            <div class="grid grid-cols-3 gap-8 mb-10">
                <div
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-2xl font-bold text-gray-900">Total Bantuan</h3>
                    ...
                    <p class="text-6xl font-bold text-gray-900 mb-3">{{ number_format($totalHelps) }}</p>
                    <p class="text-base text-gray-500">Permintaan bantuan terdaftar</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-6xl font-bold text-yellow-600 mb-3">{{ number_format($pendingHelps) }}</p>
                    <p class="text-base text-gray-500">Menunggu persetujuan</p>
                </div>

                <div
                    class="bg-white rounded-2xl shadow-md border border-gray-200 p-10 hover:shadow-lg transition-shadow">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-2xl font-bold text-gray-900">Selesai</h3>
                    ...
                    <p class="text-6xl font-bold text-green-600 mb-3">{{ number_format($completedHelps) }}</p>
                    <p class="text-base text-gray-500">Bantuan terselesaikan</p>
                </div>
            </div>
