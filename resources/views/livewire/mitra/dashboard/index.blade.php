...
<div>
        ...
        <div
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-5 gap-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-white/90 mt-0.5 drop-shadow-sm">Selamat datang kembali — kelola
                                pekerjaan
                                dan saldo Anda</p>
                        </div>
                    </div>
                ...
                <div class="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div
                        class="col-span-2 bg-white/15 backdrop-blur-md rounded-2xl p-4 shadow-lg border border-white/20">
                        <div class="flex items-center justify-between">
                            <div>
                                <div class="text-xs text-white/90 font-medium tracking-wide uppercase mb-1">Saldo
                                    Tersedia
                                </div>
                    ...
                    <div id="promo-banner" class="rounded-2xl overflow-hidden shadow-lg">
                        <div id="promo-banner-slide"
                            ...
                            <div class="text-center relative z-10">
                                ...
                                <div id="promo-desc" class="text-sm opacity-90 drop-shadow-sm">Dapatkan bonus saldo dan
                                    insentif
                                    khusus.</div>
                            </div>
                        </div>
                    ...
                    @forelse($recommendedHelps as $help)
                        ...
                        @if($loop->iteration === 5)
                            <a href="{{ url('/mitra/helps') }}"
                                class="relative block shrink-0 w-44 sm:w-48 h-40 bg-gradient-to-br from-gray-50 to-white rounded-2xl border-2 border-dashed border-gray-200 shadow-sm hover:shadow-lg flex items-center justify-center snap-start hover:border-primary-300 hover:bg-primary-50/30 transition-all duration-300 transform hover:-translate-y-1">
                                <div class="text-center px-4">
                                    <div
                                        class="w-10 h-10 mx-auto mb-2 rounded-xl bg-primary-50 flex items-center justify-center">
                                    ...
                                    <div class="text-xs font-bold text-gray-800 mb-1">Lihat Semua</div>
                                    <div class="text-[10px] text-gray-500 leading-tight">Daftar lengkap bantuan</div>
                                    <div class="mt-2">
                                        <span
                                            class="inline-block px-2.5 py-1 rounded-lg bg-primary-500 text-white text-[10px] font-semibold shadow-sm">
                                            Buka
                                        </span>
                                    </div>
                                </div>
    ...
    <!-- Help Preview Modal (Before Taking) -->
    <div id="helpPreviewModal" class="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 hidden">
        <div class="bg-white rounded-2xl w-11/12 max-w-md p-6 shadow-xl">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div id="previewAmount"
                        class="inline-block bg-green-100 text-green-700 px-3 py-1.5 rounded-lg font-bold text-sm">
                        💰 Rp 0
                    </div>
                </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                    ...
                    <p class="text-xs text-blue-700">
                        Deskripsi, alamat lengkap, lokasi di peta, foto, dan kontak customer akan ditampilkan setelah
                        Anda
                        mengambil bantuan ini.
                    </p>
                </div>
            </div>
            ...
            <div class="flex gap-3 mt-6">
                <button onclick="closePreviewModal()"
                    class="flex-1 bg-gray-100 text-gray-700 px-4 py-2.5 rounded-xl font-bold hover:bg-gray-200 transition">
                    Batal
                </button>
                <a id="previewTakeLink" href="#"
                    class="flex-1 bg-primary-500 text-white px-4 py-2.5 rounded-xl font-bold text-center hover:bg-primary-600 transition">
                    Lihat Detail
                </a>
            </div>
        </div>
    ...
    <script>
        function showHelpPreview(helpId, title, amount) {
            ...
            document.getElementById('previewTakeLink').href = '/mitra/help/' + helpId;
