...
@section('content')
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between mb-4">
            <div>
                <h2 class="text-xl font-semibold">Bantuan Disetujui</h2>
                <p class="text-sm text-gray-500">Daftar bantuan yang sudah disetujui.</p>
            </div>
            <div class="flex items-center gap-2">
                <input wire:model.debounce.500ms="search" type="text" placeholder="Cari..." class="px-3 py-2 border rounded" />
            </div>
        </div>
                ...
                <tbody>
                    @forelse($helps as $help)
                        <tr class="border-t">
                            ...
                            <td class="px-3 py-2">
                                <a href="#" class="px-3 py-1 bg-gray-100 text-gray-700 rounded text-xs">Detail</a>
                                <button wire:click="rejectHelp({{ $help->id }})" class="px-3 py-1 bg-red-500 text-white rounded text-xs">Tolak</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
