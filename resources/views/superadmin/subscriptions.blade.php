...
<head>
    ...
    <title>Langganan Mitra - Dihapus</title>
...
<body class="antialiased">
    <div class="min-h-screen bg-gray-50 flex items-center justify-center p-8">
        <div class="bg-white rounded-xl shadow-lg p-12 text-center max-w-xl">
            <h1 class="text-2xl font-bold text-gray-900">Halaman Langganan Mitra Dihapus</h1>
            <p class="text-sm text-gray-600 mt-3">Halaman pengelolaan langganan mitra untuk Superadmin telah dihapus.
            </p>
            <div class="mt-6">
    ...
    <nav class="p-4">
        ...
        <!-- Superadmin categories link removed -->
    ...
    <main class="flex-1 ml-64 overflow-y-auto min-h-screen">
        <header class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-10">
            <div class="px-8 py-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Langganan Mitra</h1>
                    <p class="text-sm text-gray-600 mt-1">Kelola paket langganan untuk mitra</p>
                </div>
            </div>
        </header>
        ...
        <div class="p-12">
            <div class="bg-white rounded-2xl shadow-lg p-20 text-center">
                ...
                <h2 class="text-2xl font-bold text-gray-900 mb-3">Fitur Langganan Mitra</h2>
                <p class="text-gray-600 text-lg">Halaman ini sedang dalam pengembangan.</p>
                <p class="text-gray-500 mt-2">Fitur manajemen paket langganan akan segera hadir.</p>
            </div>
        </div>
    </main>
    </div>
